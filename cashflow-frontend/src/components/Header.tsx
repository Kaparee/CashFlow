...
const Header: React.FC = () => {
    ...
    return (
        <div className='row align-items-end text-center p-3'>
            <div className='offset-1 col-2'>
                <img src={logo} className='img-fluid' alt='Logo CashFlow' />
            </div>
            <div className='col-6 d-flex align-items-end justify-content-center'>
                ...
                <div className='nav-group bg-secondary rounded-5 px-2 py-1 position-relative d-flex'>
                    ...
                    <span ref={sliderRef} className='nav-slider position-absolute rounded-5'></span>
                </div>
